...
const Index: React.FC<IndexProps> = ({ language, onLanguageChange }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      ...
      {/* Moving News Ticker - Enhanced */}
      <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 py-6 overflow-hidden">
        <div className="marquee-container">
          <div className="marquee-text text-white text-xl font-bold">
